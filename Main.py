...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = score_surface.get_rect(center = (288, 600))
...
game_over_surface = pygame.transform.scale2x(pygame.image.load('flappy-bird-assets/sprites/message.png').convert_alpha())
